...
LOCAL_SRC_FILES := arduino.c avr.c avr910.c avrftdi.c avrftdi_tpi.c avrpart.c bitbang.c buspirate.c butterfly.c config.c config_gram.c crc16.c dfu.c fileio.c flip1.c flip2.c jtag3.c jtagmkI.c jtagmkII.c linuxgpio.c lists.c main.c par.c pgm.c pgm_type.c pickit2.c pindefs.c ppi.c ppiwin.c safemode.c ser_avrdoper.c ser_posix.c serbb_posix.c stk500.c stk500generic.c stk500v2.c term.c update.c usb_libusb.c usbasp.c usbtiny.c wiring.c
LOCAL_CFLAGS = -Wall -pedantic -Wno-gnu-zero-variadic-macro-arguments -Wno-pointer-arith -Wno-macro-redefined -Wno-format-pedantic -Wno-empty-translation-unit -Wno-tautological-constant-out-of-range-compare -std=c99 -g

include $(BUILD_STATIC_LIBRARY)
include $(CLEAR_VARS)
LOCAL_MODULE := avrdude-jni
LOCAL_STATIC_LIBRARIES := avrdude
